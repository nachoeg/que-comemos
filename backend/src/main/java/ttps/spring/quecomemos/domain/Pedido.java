...
public class Pedido {
    ...
    @ManyToMany
    @JoinTable(name = "PedidoMenu", joinColumns = @JoinColumn(name = "pedidoId"), inverseJoinColumns = @JoinColumn(name = "menuId"))
    private Set<Menu> menus;

    @ManyToMany
    @JoinTable(name = "PedidoComida", joinColumns = @JoinColumn(name = "pedidoId"), inverseJoinColumns = @JoinColumn(name = "comidaId"))
